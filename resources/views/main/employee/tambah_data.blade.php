                    ...
                    <div class="card-body">
                        ...
                        @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input  name="general_tanggal_lahir" type="text" class="form-control" required>
                                </div>
                            </div>                                                      
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input  name="general_tinggi_badan" type="text" class="form-control" required>
                                </div>
                            </div>                                                      
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label form-label">BERAT BADAN</label>
                                <div class="col-sm-9">
                                    <input  name="genaral_berat_badan" type="text" class="form-control" required>
                                </div>
                            </div>                                                      
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label form-label">MULAI</label>
                                <div class="col-sm-9">
                                    <input  name="general_riwayat_kontrak_1_mulai" type="text" class="form-control" required>
                                </div>
                                <label class="col-sm-3 col-form-label form-label">BERAKHIR</label>
                                <div class="col-sm-9">
                                    <input  name="general_riwayat_kontrak_1_berakhir" type="text" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label form-label">MULAI</label>
                                <div class="col-sm-9">
                                    <input  name="general_riwayat_kontrak_2_mulai" type="text" class="form-control" required>
                                </div>
                                <label class="col-sm-3 col-form-label form-label">BERAKHIR</label>
                                <div class="col-sm-9">
                                    <input  name="general_riwayat_kontrak_2_berakhir" type="text" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label form-label">MULAI</label>
                                <div class="col-sm-9">
                                    <input  name="general_riwayat_kontrak_3_mulai" type="text" class="form-control" required>
                                </div>
                                <label class="col-sm-3 col-form-label form-label">BERAKHIR</label>
                                <div class="col-sm-9">
                                    <input  name="general_riwayat_kontrak_3_berakhir" type="text" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label form-label">CATATAN</label>
                                <div class="col-sm-9">
                                    <input  name="general_catatan" type="text" class="form-control" required>
                                </div>
                            </div>
